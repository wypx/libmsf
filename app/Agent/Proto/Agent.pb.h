...
inline void Chap::set_hash(const void* value,
    size_t size) {
...
inline void LoginRequest::set_token(const void* value,
    size_t size) {
...
inline void LoginReponse::set_msg(const void* value,
    size_t size) {
...
inline void NodeInfo::set_name(const void* value,
    size_t size) {
...
inline void HeartBeatRequest::set_name(const void* value,
    size_t size) {
