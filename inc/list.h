...
//http://blog.csdn.net/cc289123557/article/details/51490584
...
/*	链表是内核最经典的数据结构之一,
 	说到链表就不得不提及内核最经典(没有之一)的宏container_o.?
	container_of似乎就是为链表而生的,
	它的主要作用是根据一个结构体变量中的
	一个域成员变量的指针来获取指向整个结构体变量的指针,
	最典型的应用就是根据链表节点获取链表上的元素对象
*/
//http://blog.csdn.net/punk_lover/article/details/19564635
