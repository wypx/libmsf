...
#define MSF_ATTRIBUTE_WIKE_ALIAS(func) __attribute__ ((weak, alias(MSF_MACROSTR(func))))
#else
#define MSF_ATTRIBUTE_WIKE_ALIAS
#endif

#ifndef MSF_ATTRIBUTE_WIKEREF_ALIAS
#define MSF_ATTRIBUTE_WIKEREF_ALIAS(func) __attribute__ ((weakref, alias(MSF_MACROSTR(func))))
#else
