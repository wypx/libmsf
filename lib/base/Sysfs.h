 ...
 *
 */
#ifndef __MSF_SYSFS__
#define __MSF_SYSFS__
...
extern void sysfs_device_set_values(struct sysfs_device *dev,
                                    const char *devpath, const char *subsystem,
                                    const char *driver);
...
extern struct sysfs_device *sysfs_device_get_parent_with_subsystem(
...
extern int sysfs_lookup_devpath_by_subsys_id(char *devpath, size_t len,
...
extern int sysfs_get_uint64(char *id, char *subsys, char *param,
                            uint64_t *value);
extern int sysfs_get_uint8(char *id, char *subsys, char *param, uint8_t *value);
