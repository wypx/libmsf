...
std::string Encoding::Base32Decode(std::string_view str) {
  static const unsigned char base32[128] = {
      ...
      0xFF, 0x20, 0xFF, 0xFF, 0xFF, 0x00, 0x01, 0x02, 0x03, 0x04, 0x05, 0x06,
  ...
  for (size_t i = 0, j = 0; i < ilength;) {
    ...
    // Validate ASCII
    assert(((n1 < 0x80) && (n2 < 0x80) && (n3 < 0x80) && (n4 < 0x80) &&
            (n5 < 0x80) && (n6 < 0x80) && (n7 < 0x80) && (n8 < 0x80)) &&
           "Invalid Base32 content!");
    if ((n1 >= 0x80) || (n2 >= 0x80) || (n3 >= 0x80) || (n4 >= 0x80) ||
        (n5 >= 0x80) || (n6 >= 0x80) || (n7 >= 0x80) || (n8 >= 0x80))
      return "";
    ...
    assert(((n3 <= 32) && (n4 <= 32) && (n5 <= 32) && (n6 <= 32) &&
            (n7 <= 32) && (n8 <= 32)) &&
           "Invalid Base32 content!");
    if ((n3 > 32) || (n4 > 32) || (n5 > 32) || (n6 > 32) || (n7 > 32) ||
        (n8 > 32))
      return "";
    ...
    if (n8 == 32) {
      ...
      assert((((n7 == 32) && (n6 == 32)) || (n7 != 32)) &&
             "Invalid Base32 content!");
      if (n6 == 32) {
        result.resize(result.size() - 1);
        if (n5 == 32) {
          result.resize(result.size() - 1);
          assert((((n4 == 32) && (n3 == 32)) || (n4 != 32)) &&
                 "Invalid Base32 content!");
          if (n3 == 32) {
            result.resize(result.size() - 1);
          }
