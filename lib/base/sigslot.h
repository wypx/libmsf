...
// QUICK DOCUMENTATION
//
//        (see also the full documentation at http://MSF.sourceforge.net/)
//
//    #define switches
//      SIGSLOT_PURE_ISO:
...
//    USING THE LIBRARY
//
//      See the full documentation at http://MSF.sourceforge.net/
//
// Libjingle specific:
//
...
#ifndef BASE_SIGSLOT_SIGSLOT_H_
#define BASE_SIGSLOT_SIGSLOT_H_

#include <cstring>
#include <list>
#include <set>

// On our copy of MSF.h, we set single threading as default.
...
class has_slots_interface {
 ...
 protected:
  ...
  // (it was virtual in a previous version of MSF).
...
// The previous verion of MSF didn't use variadic templates, so you would
// need to write "MSF::signal2<Arg1, Arg2>", for example.
// Now you can just write "MSF::signal<Arg1, Arg2>", but these aliases
