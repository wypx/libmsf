...
/*
   ...
   http://msdn.microsoft.com/en-us/library/windows/desktop/ms687419(v=vs.85).aspx
    Not for intel c++ compiler, so ignore
   http://software.intel.com/en-us/forums/topic/296168
*/
#define MSF_SPIN_LOCK_PAUSE_() YieldProcessor()
...
*/
#define MSF_SPIN_LOCK_PAUSE_() __asm__ __volatile__("pause")
...
*/
#define MSF_SPIN_LOCK_PAUSE_() __asm__ __volatile__("hint @pause")
#elif defined(__arm__)
/*
    See: ARM Architecture Reference Manuals (YIELD)
         http://infocenter.arm.com/help/index.jsp?topic=/com.arm.doc.subset.architecture.reference/index.html
*/
#define MSF_SPIN_LOCK_PAUSE_() __asm__ __volatile__("yield")
#endif
#endif /*compilers*/

#if !defined(MSF_SPIN_LOCK_PAUSE_)
/*
    Just use a compiler fence, prevent compiler from optimizing loop
*/
#define MSF_SPIN_LOCK_PAUSE_() \
  std::atomic_signal_fence(std::memory_order_seq_cst)
#endif /*!defined(MSF_SPIN_LOCK_PAUSE_)*/
