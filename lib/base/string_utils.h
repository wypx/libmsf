 ...
 *
 **************************************************************************/
#ifndef BASESTRING_UTILS_H_
#define BASESTRING_UTILS_H_
...
//! String utilities
/*!
    String utilities contains methods for UPPER/lower case conversions,
   join/split strings
...
class StringUtils {
 public:
  ...
  /*!
      ...
      \return 'true' if given character is blank, 'false' if given character is
     not blank
  */
  ...
  /*!
      ...
      \return 'true' if given C-string is blank, 'false' if given C-string is
     not blank
  */
  ...
  /*!
      ...
      \return 'true' if given string is blank, 'false' if given string is not
     blank
  */
  ...
  */
  ...
  /*!
      ...
      \return 'true' if two strings are equal, 'false' if two strings are
     different
  */
  ...
  */
  ...
  /*!
      ...
      \return 'true' if the substring was found, 'false' if the substring was
     not found
  */
  ...
  */
  ...
  /*!
      ...
      \return 'true' if first occurrence of substring was found and relapsed,
     'false' if the substring was not found
  */
  static bool ReplaceFirst(std::string& str, std::string_view substr,
  ...
  /*!
      ...
      \param substr - Substring to find
      \param with - Substring to replace
      \return 'true' if last occurrence of substring was found and relapsed,
     'false' if the substring was not found
  */
  static bool ReplaceLast(std::string& str, std::string_view substr,
                          std::string_view with);
  ...
  /*!
      ...
      \param substr - Substring to find
      \param with - Substring to replace
      \return 'true' if all occurrences of substring were found and relapsed,
     'false' if the substring was not found
  */
  static bool ReplaceAll(std::string& str, std::string_view substr,
                         std::string_view with);
  ...
  /*!
      ...
      \return 'true' if the given string starts with the specific prefix,
     'false' if the given string does not start with the specific prefix
  */
  ...
  /*!
      ...
      \return 'true' if the given string ends with the specific suffix, 'false'
     if the given string does not end with the specific suffix
  */
  ...
  */
  static std::vector<std::string> Split(std::string_view str,
                                        ...
                                        bool skip_empty = false);
  //! Split the string into tokens by the any character in the given delimiter
  // string
  /*!
      \param str - String to split
  ...
  */
  static std::vector<std::string> SplitByAny(std::string_view str,
  ...
  */
  static std::string Join(const std::vector<std::string>& tokens,
                          bool skip_empty = false, bool skip_blank = false);
  ...
  */
  static std::string Join(const std::vector<std::string>& tokens,
                          char delimiter, bool skip_empty = false,
  ...
  */
  static std::string Join(const std::vector<std::string>& tokens,
                          const char* delimiter, bool skip_empty = false,
                          bool skip_blank = false);
...
/*! \example string_utils.cp String utilities example */
