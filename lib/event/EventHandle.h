...
*
**************************************************************************/
#ifndef EVENT_EVNETHANDLE_H
#define EVENT_EVNETHANDLE_H
  ...
  public:
    struct EventHandleRegister
    {
        EventHandleRegister()
        {
            ...
            std::cout << "EventHandleRegister type: " << typeName << " cmd: " ++cmd << std::endl;
...
void EventHandleTest()
{
    ...
    EventHandleFactory::Instance().getHandle(100)->handleMessage(0, nullptr, nullptr);
}
