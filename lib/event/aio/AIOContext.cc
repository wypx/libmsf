...
std::vector< AIOContext::AioEvent > AIOContext::collectRequests( std::size_t min_requests, std::size_t max_requests )
{
...
AIOContext::AioEvent::AioEvent(io_event _event)
: event( _event )
{
...
AIOContext::AioEvent::EventType AIOContext::AioEvent::getType()
{
    return type;
}
