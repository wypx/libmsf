...
// @@protoc_insertion_point(class_specific_merge_from_start:fraft.NodeStat)
  ...
  if (from._internal_cgxid() != 0) {
    _internal_set_cgxid(from._internal_cgxid());
  }
  if (from._internal_mgxid() != 0) {
