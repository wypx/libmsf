...
Candidate::Candidate(int component, const std::string& protocol,
                     const SocketAddress& address, uint32_t priority,
                     const std::string& username, const std::string& password,
                     const std::string& type, uint32_t generation,
                     const std::string& foundation, uint16_t network_id,
...
bool Candidate::operator!=(const Candidate& o) const { return !(*this == o); }
