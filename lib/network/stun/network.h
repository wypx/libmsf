...
class BasicNetworkManager : public NetworkManagerBase,
 ...
 protected:
  ...
  void ConvertIfAddrs(ifaddrs* interfaces, IfAddrsConverter* converter,
...
class Network {
 public:
  ...
  signal1<const Network*> SignalTypeChanged;

  // This signal is fired whenever network preference changes.
  signal1<const Network*> SignalNetworkPreferenceChanged;
