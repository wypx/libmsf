...
static const SocketAddress kTurnIPv6IntAddr(
    "2400:4030:2:2c00:be30:abcd:efab:cdef", cricket::TURN_SERVER_PORT);
...
class TurnPortTest : public ::testing::Test,
 ...
 public:
  ...
  virtual void OnMessage(rtc::Message* msg) {
    ...
    if (msg->message_id == MSG_TESTFINISH) test_finish_ = true;
  }
  ...
  void OnSocketReadPacket(rtc::AsyncPacketSocket* socket, const char* data,
  ...
  void CreateTurnPort(const std::string& username, const std::string& password,
