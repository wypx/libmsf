#ifndef BASE_ASYNC_PACKET_SOCKET_H_
#define BASE_ASYNC_PACKET_SOCKET_H_
...
struct PacketOptions {
  ...
  // When used with RTP packets (for example, webPacketOptions), the value
...
class AsyncPacketSocket : public has_slots<>, public Noncopyable {
 public:
  ...
  signal5<AsyncPacketSocket*, const char*, size_t, const SocketAddress&,
          // TODO(bugs.webMSF.org/9584): Change to passing the int64_t
          // timestamp by value.
          const int64_t&> SignalReadPacket;

  // Emitted each time a packet is sent.
  signal2<AsyncPacketSocket*, const SentPacket&> SignalSentPacket;
...
#endif  // BASE_ASYNC_PACKET_SOCKET_H_
