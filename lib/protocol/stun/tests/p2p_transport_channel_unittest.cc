 ...
 public:
  P2PTransportChannelTestBase()
      : vss_(new rtc::VirtualSocketServer()),
        ...
        socks_server1_(ss_.get(), kSocksProxyAddrs[0], ss_.get(),
                       kSocksProxyAddrs[0]),
        socks_server2_(ss_.get(), kSocksProxyAddrs[1], ss_.get(),
                       kSocksProxyAddrs[1]),
        force_relay_(false) {
 ...
 protected:
  ...
  struct Result {
    Result(const std::string& controlling_type,
           ...
           const std::string& controlled_protocol, int wait)
  ...
  struct Endpoint : public sigslot::has_slots<> {
    ...
    ChannelData* GetChannelData(rtc::PacketTransportInternal* transport) {
      if (!HasTransport(transport)) return NULL;
  ...
  void CreateChannels(const IceConfig& ep1_config, const IceConfig& ep2_config,
  ...
  P2PTransportChannel* CreateChannel(int endpoint, int component,
  ...
  void AddAddress(int endpoint, const SocketAddress& addr,
                  const std::string& ifname, rtc::AdapterType adapter_type) {
    GetEndpoint(endpoint)
        ->network_manager_.AddInterface(addr, ifname, adapter_type);
  }
  ...
  static bool CheckCandidate(P2PTransportChannel* channel, SocketAddress from,
                             SocketAddress to) {
  ...
  static bool CheckCandidatePair(P2PTransportChannel* ch1,
                                 P2PTransportChannel* ch2, SocketAddress from,
                                 SocketAddress to) {
  ...
  void OnCandidateGathered(IceTransportInternal* ch, const Candidate& c) {
    if (force_relay_ && c.type() != RELAY_PORT_TYPE) return;
  ...
  void OnReadPacket(rtc::PacketTransportInternal* transport, const char* data,
                    size_t len, const int64_t& /* packet_time_us */,
                    int flags) {
  ...
  bool CheckDataOnChannel(IceTransportInternal* channel, const char* data,
                          int len) {
...
const P2PTransportChannelTestBase::Result
    P2PTransportChannelTestBase::kLocalUdpToLocalUdp("local", "udp", "local",
                                                     "udp", 1000);
const P2PTransportChannelTestBase::Result
    P2PTransportChannelTestBase::kLocalUdpToStunUdp("local", "udp", "stun",
                                                    "udp", 1000);
const P2PTransportChannelTestBase::Result
    P2PTransportChannelTestBase::kLocalUdpToPrflxUdp("local", "udp", "prflx",
                                                     "udp", 1000);
const P2PTransportChannelTestBase::Result
    P2PTransportChannelTestBase::kPrflxUdpToLocalUdp("prflx", "udp", "local",
                                                     "udp", 1000);
const P2PTransportChannelTestBase::Result
    P2PTransportChannelTestBase::kStunUdpToLocalUdp("stun", "udp", "local",
                                                    "udp", 1000);
const P2PTransportChannelTestBase::Result
    P2PTransportChannelTestBase::kStunUdpToStunUdp("stun", "udp", "stun", "udp",
                                                   1000);
const P2PTransportChannelTestBase::Result
    P2PTransportChannelTestBase::kStunUdpToPrflxUdp("stun", "udp", "prflx",
                                                    "udp", 1000);
const P2PTransportChannelTestBase::Result
    P2PTransportChannelTestBase::kPrflxUdpToStunUdp("prflx", "udp", "stun",
                                                    "udp", 1000);
const P2PTransportChannelTestBase::Result
    P2PTransportChannelTestBase::kLocalUdpToRelayUdp("local", "udp", "relay",
                                                     "udp", 2000);
const P2PTransportChannelTestBase::Result
    P2PTransportChannelTestBase::kPrflxUdpToRelayUdp("prflx", "udp", "relay",
                                                     "udp", 2000);
const P2PTransportChannelTestBase::Result
    P2PTransportChannelTestBase::kRelayUdpToPrflxUdp("relay", "udp", "prflx",
                                                     "udp", 2000);
const P2PTransportChannelTestBase::Result
    P2PTransportChannelTestBase::kLocalTcpToLocalTcp("local", "tcp", "local",
                                                     "tcp", 3000);
const P2PTransportChannelTestBase::Result
    P2PTransportChannelTestBase::kLocalTcpToPrflxTcp("local", "tcp", "prflx",
                                                     "tcp", 3000);
const P2PTransportChannelTestBase::Result
    P2PTransportChannelTestBase::kPrflxTcpToLocalTcp("prflx", "tcp", "local",
                                                     "tcp", 3000);
...
class P2PTransportChannelTest : public P2PTransportChannelTestBase {
 protected:
  ...
  void ConfigureEndpoints(Config config1, Config config2, int allocator_flags1,
...
const P2PTransportChannelTest::Result* P2PTransportChannelTest::kMatrix
    [NUM_CONFIGS][NUM_CONFIGS] = {
        //      OPEN  CONE  ADDR  PORT  SYMM  2CON  SCON  !UDP  !TCP  HTTP  PRXH
        //      PRXS
        /*OP*/ {LULU, LUSU, LUSU, LUSU, LUPU, LUSU,
                LUPU, LTPT, LTPT, LSRS, NULL, LTPT},
        /*CO*/
        {SULU, SUSU, SUSU, SUSU, SUPU, SUSU,
         SUPU, NULL, NULL, LSRS, NULL, LTRT},
        /*AD*/
        {SULU, SUSU, SUSU, SUSU, SUPU, SUSU,
         SUPU, NULL, NULL, LSRS, NULL, LTRT},
        /*PO*/
        {SULU, SUSU, SUSU, SUSU, RUPU, SUSU,
         RUPU, NULL, NULL, LSRS, NULL, LTRT},
        /*SY*/
        {PULU, PUSU, PUSU, PURU, PURU, PUSU,
         PURU, NULL, NULL, LSRS, NULL, LTRT},
        /*2C*/
        {SULU, SUSU, SUSU, SUSU, SUPU, SUSU,
         SUPU, NULL, NULL, LSRS, NULL, LTRT},
        /*SC*/
        {PULU, PUSU, PUSU, PURU, PURU, PUSU,
         PURU, NULL, NULL, LSRS, NULL, LTRT},
        /*!U*/
        {LTPT, NULL, NULL, NULL, NULL, NULL,
         NULL, LTPT, LTPT, LSRS, NULL, LTRT},
        /*!T*/
        {PTLT, NULL, NULL, NULL, NULL, NULL,
         NULL, PTLT, LTRT, LSRS, NULL, LTRT},
        /*HT*/
        {LSRS, LSRS, LSRS, LSRS, LSRS, LSRS,
         LSRS, LSRS, LSRS, LSRS, NULL, LSRS},
        /*PR*/
        {NULL, NULL, NULL, NULL, NULL, NULL,
         NULL, NULL, NULL, NULL, NULL, NULL},
        /*PR*/
        {LTRT, LTRT, LTRT, LTRT, LTRT, LTRT,
         LTRT, LTRT, LTRT, LSRS, NULL, LTRT}, };
...
#define P2P_TEST_SET(x)                                                 \
  P2P_TEST(x, OPEN) P2P_TEST(x, NAT_FULL_CONE)                          \
      P2P_TEST(x, NAT_ADDR_RESTRICTED) P2P_TEST(x, NAT_PORT_RESTRICTED) \
      P2P_TEST(x, NAT_SYMMETRIC) P2P_TEST(x, NAT_DOUBLE_CONE)           \
      P2P_TEST(x, NAT_SYMMETRIC_THEN_CONE) P2P_TEST(x, BLOCK_UDP)       \
      P2P_TEST(x, BLOCK_UDP_AND_INCOMING_TCP)                           \
      P2P_TEST(x, BLOCK_ALL_BUT_OUTGOING_HTTP) P2P_TEST(x, PROXY_HTTPS) \
...
TEST_F(P2PTransportChannelTest,
  ...
  EXPECT_EQ_SIMULATED_WAIT(1, GetEndpoint(0)->GetIceRegatheringCountForReason(
...
class P2PTransportChannelSameNatTest : public P2PTransportChannelTestBase {
 protected:
  ...
  void ConfigureEndpoint(rtc::NATSocketServer::Translator* nat, int endpoint,
                         Config config) {
...
class P2PTransportChannelMultihomedTest : public P2PTransportChannelTestBase {
 public:
  const Connection* GetConnectionWithRemoteAddress(
      P2PTransportChannel* channel, const SocketAddress& address) {
...
class P2PTransportChannelPingTest : public ::testing::Test,
 ...
 protected:
  ...
  Connection* WaitForConnectionTo(P2PTransportChannel* ch,
                                  const std::string& ip, int port_num,
                                  rtc::ThreadProcessingFakeClock* clock =
                                      nullptr) {
    if (clock == nullptr) {
  ...
  Connection* GetConnectionTo(P2PTransportChannel* ch, const std::string& ip,
                              int port_num) {
  ...
  void ReceivePingOnConnection(
      Connection* conn, const std::string& remote_ufrag, int priority,
      uint32_t nomination,
  ...
  void ReceivePingOnConnection(Connection* conn,
                               const std::string& remote_ufrag, int priority,
...
class P2PTransportChannelMostLikelyToWorkFirstTest
 ...
 public:
  ...
  // it.
  void VerifyNextPingableConnection(const std::string& local_candidate_type,
                                    const std::string& remote_candidate_type,
                                    const std::string& relay_protocol_type =
                                        UDP_PROTOCOL_NAME) {
...
TEST_F(P2PTransportChannelTest,
  ...
  ON_CALL(*mock_async_resolver, Destroy)
      .WillByDefault([mock_async_resolver] { delete mock_async_resolver; });
  webrtc::MockAsyncResolverFactory mock_async_resolver_factory;
  EXPECT_CALL(mock_async_resolver_factory, Create())
      .WillOnce(Return(mock_async_resolver));
...
TEST_F(P2PTransportChannelTest,
  ...
  for (const auto& candidates_data : GetEndpoint(0)->saved_candidates_) {
    ...
    if (local_candidate_ep1.type() == LOCAL_PORT_TYPE) {
      ...
      rtc::SocketAddress resolved_address_ep1(local_candidate_ep1.address());
      resolved_address_ep1.SetResolvedIP(kPublicAddrs[0].ipaddr());
      EXPECT_CALL(mock_async_resolver, GetResolvedAddress(_, _)).WillOnce(
...
class MockMdnsResponder : public webrtc::MdnsResponderInterface {
 public:
  MOCK_METHOD(void, CreateNameForAddress,
              (const rtc::IPAddress&, NameCreatedCallback), (override));
  MOCK_METHOD(void, RemoveNameForAddress,
              (const rtc::IPAddress&, NameRemovedCallback), (override));
};
...
TEST_F(P2PTransportChannelTest,
  ...
  EXPECT_CALL(*mock_mdns_responder, CreateNameForAddress(_, _))
      ...
      .WillOnce(Return());
  GetEndpoint(0)
      ->network_manager_.set_mdns_responder(std::move(mock_mdns_responder));
