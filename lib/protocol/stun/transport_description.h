...
struct IceParameters {
  ...
  // static RTCError<IceParameters> Parse(std::string_view raw_ufrag,
  //                                      std::string_view raw_pwd);
...
struct TransportDescription {
  ...
  //                      const std::string& ice_ufrag, const std::string&
  // ice_pwd,
  //                      IceMode ice_mode, ConnectionRole role,
