 ...
 *
 **************************************************************************/
#ifndef __MSF_INETADDRESS_H__
#define __MSF_INETADDRESS_H__
...
class InetAddress : public Copyable
{
 public:
    InetAddress();
    explicit InetAddress(const std::string & host = DEFAULT_IPANY, const uint16_t port = DEFAULT_PORT,                        const sa_family_t family = AF_INET, const int proto = AF_INET);
    ...
    std::string hostPort2String() const { return _host + ":" + std::to_string(_port); }
